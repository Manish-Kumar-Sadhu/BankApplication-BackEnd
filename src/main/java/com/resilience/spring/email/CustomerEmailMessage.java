...
public class CustomerEmailMessage {
	...
	public static String text = "Your registration with our bank is complete. Our team will activate your account in two business days.";
	...
	public static String message= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r\n" + 
			...
			"                   <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;\"> \r\n" + 
			"                     <tr style=\"border-collapse:collapse;\"> \r\n" + 
			"                      <td class=\"es-m-txt-l\" align=\"left\" style=\"padding:0;Margin:0;padding-top:15px;\"><h3 style=\"Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#333333;\">Hello " + CustomerEmailMessage.customer_name + "</h3></td> \r\n" + 
			"                     </tr> \r\n" + 
			"                     <tr style=\"border-collapse:collapse;\"> \r\n" + 
	...
	public static void setCustomer_name(String customer_name) {
		CustomerEmailMessage.customer_name = customer_name;
	}
	...
	public static void setSubject(String subject) {
		CustomerEmailMessage.subject = subject;
	}
	...
	public static void setText(String text) {
		CustomerEmailMessage.text = text;
	}
	...
	public static void setMessage(String message) {
		CustomerEmailMessage.message = message;
	}
