...
@Component
public class AccountRegistrationEmail {

	public static String customer_name ="Account Holder!";

	public static String to;

	public static String subject;

	public static String text = "You have successfullt set up your account.\n The banking team will review and activate the account in one business day.";
	...
	public static String message= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r\n" + 
			...
			"                   <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;\"> \r\n" + 
			"                     <tr style=\"border-collapse:collapse;\"> \r\n" + 
			"                      <td class=\"es-m-txt-l\" align=\"left\" style=\"padding:0;Margin:0;padding-top:15px;\"><h3 style=\"Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#333333;\">Hello " + AccountRegistrationEmail.customer_name + "</h3></td> \r\n" + 
			"                     </tr> \r\n" + 
			"                     <tr style=\"border-collapse:collapse;\"> \r\n" + 
	...
	public static void setCustomer_name(String customer_name) {
		AccountRegistrationEmail.customer_name = customer_name;
	}
	...
	public static void setTo(String to) {
		AccountRegistrationEmail.to = to;
	}
	...
	public static void setSubject(String subject) {
		AccountRegistrationEmail.subject = subject;
	}
	...
	public static void setText(String text) {
		AccountRegistrationEmail.text = text;
	}
	...
	public static void setMessage(String message) {
		AccountRegistrationEmail.message = message;
	}
